...
public interface Vector3dInterface {
     ...
     * for example:
     *
     *       PhysicsEngine.PhysicsEngine.Planets.Vectors.Vector3d a = Vector();
     *       double h = 2;
     *       PhysicsEngine.PhysicsEngine.Planets.Vectors.Vector3d b = Vector();
     *       ahb = a.addMul(h, b);
     *
     ...
     * PhysicsEngine.PhysicsEngine.Planets.Vectors.Vector3d(-1.0, 2, -3.0) should print out (-1.0,2.0,-3.0)
     */

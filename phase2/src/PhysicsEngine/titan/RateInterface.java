 ...
 * and to participate in the addMul method of StateInterface. A concrete PhysicsEngine.PhysicsEngine.Planets.InterfacesImplementations.State class
 * must cast the rate argument of addMul to a concrete PhysicsEngine.PhysicsEngine.Planets.InterfacesImplementations.Rate class of the expected type.
 *
